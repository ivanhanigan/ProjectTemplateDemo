...
* NMMAPSlite readCity()
#+name:NMMAPSliteEgGAM-qc.png copy
#+begin_src R :session *Rroot* :exports none :eval no
  file.copy('analysis/reports/NMMAPSliteEgGAM-qc.png', 'NMMAPSliteEgGAM-qc.png')
#+end_src
...
# \end{figure}
* NMMAPSlite GAM
#+name:NMMAPSliteEgGAM-exposureResponse.png copy
#+begin_src R :session *Rroot* :exports none :eval no
  file.copy('analysis/reports/NMMAPSliteEgGAM-exposureResponse.png', 'NMMAPSliteEgGAM-exposureResponse.png')
#+end_src
...
#+name:NMMAPSliteEgGAM-exposureResponse-extension.png copy
#+begin_src R :session *Rroot* :exports none :eval no
  file.copy('analysis/reports/NMMAPSliteEgGAM-exposureResponse-extension.png', 'NMMAPSliteEgGAM-exposureResponse-extension.png')
#+end_src
