...
# 5 open the new file 'analysis/reports/letters.tex' and run LaTeX to produce the report
...
Which I've also followed to prepare this demo using the tutorial and data from the package website http://projecttemplate.net/getting_started.html
* Init the project
...
* First letter
#+name:fig1 copy
#+begin_src R :session *Rroot* :exports none :eval yes
